...
const ProductDetails = () => {
    ...
    // const productListNew = useSelector(allProducts)
    ...
    // const productDetail = productListNew.find((item)=>item.id === Number(productID))
    ...
    return (
        ...
        //         <img src={productDetail?.productVariants[0].image_keys.product_url} alt='product image' />
        //     </div>
