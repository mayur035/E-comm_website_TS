        ...
        updateFilter: (state, action) => {
            ...
            switch (filterType) {
                ...
                case "price":
                    ...
                    break;
                case "select":
                    state.filterSelect = filterValue;
                    break;
                case "pagination":
...
export const fetch_filter_product: any = createAsyncThunk<[], FilterData>('filterData/fetchProducts', async (body, thunkApi) => {
    ...
    const response = await axios.get(`http://localhost:3001/products?sortBy=&price=${encodedFilterPriceValue}&brands=${stringBrandArray}&category=${category}&page=${page}&productlimit=2`)
